...
class ArtConverter:
    def __init__(self, path='/Users/mymac/PycharmProjects/udemypython/algorrytmy/2021.jpg', font_size=12):
        pg.init()
        self.path = path
    ...
    def save_image(self):
        ...
        cv2.imwrite('/Users/mymac/PycharmProjects/udemypython/algorrytmy/ascii_image.jpg', cv2_img)
